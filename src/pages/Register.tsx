    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        {[...Array(8)].map((_, i) => (
          ...
          >
            {i % 2 === 0 ? (
              ...
              <Gift className="w-3 h-3 text-purple-400/40" />
            )}
          </motion.div>
        ))}
      </div>
      ...
      >
        ...
        >
          ...
          >
            Create your free account and get $10,000 virtual money
          </motion.p>
        </motion.div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            >
              ...
              <div className="relative group">
                ...
                />
                <User className="h-5 w-5 text-gray-400 absolute left-4 top-4 group-focus-within:text-blue-500 transition-colors" />
              </div>
            </motion.div>
              ...
              >
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  {isLoading ? (
                    ...
                    <Gift className="h-5 w-5 text-blue-200 group-hover:text-white transition-colors" />
                  )}
                </span>
        ...
        >
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-4 border border-green-200/50">
            ...
            <div className="flex items-center justify-center space-x-2 text-sm text-gray-600">
              ...
              <span>$10,000 virtual money</span>
              <span>•</span>
